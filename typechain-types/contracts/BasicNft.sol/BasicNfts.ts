...
export interface BasicNftsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface BasicNfts extends BaseContract {
  connect(runner?: ContractRunner | null): BasicNfts;
  waitForDeployment(): Promise<this>;

  interface: BasicNftsInterface;
